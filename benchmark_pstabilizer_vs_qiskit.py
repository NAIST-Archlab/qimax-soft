...
def benchmark(num_qubits, num_layers, avg_times):
    ...
    print("Num qubits", num_qubits, "Num layers", num_layers)
    ...
    np.savetxt(f"./data/times_lut_{num_qubits}qubit_{num_layers}layer.csv", times_lut, delimiter=",")
    np.savetxt(f"./data/times_mapping_{num_qubits}qubit_{num_layers}layer.csv", times_mapping, delimiter=",")
